  ...
  <div class="chart">
    <el-card>
      <ul class="list">
        ...
        <li>
          <div class="itemContent color2">{{titleObj.increment_questions}}</div>
          <p>新增试题</p>
        </li>
        <li>
        ...
        <li>
          <div class="itemContent color3">{{titleObj.personal_questions}}</div>
          <p>人均刷题量</p>
        </li>
        <li>
          <div class="itemContent color3">{{titleObj.total_done_questions}}</div>
          <p>总刷题量</p>
        </li>
      </ul>
    </el-card>
